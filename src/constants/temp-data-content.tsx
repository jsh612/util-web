...
제3조(납세의무자) ① 다음 각 호의 법인은 이 법에 따라 그 소득에 대한 법인세를 납부할 의무가 있다. <개정 2010. 12. 30.>
1. 내국법인
...
② 제1항에도 불구하고 다음 각 호의 어느 하나에 해당하는 신탁으로서 대통령령으로 정하는 요건을 충족하는 신탁(「자본시장과 금융투자업에 관한 법률」 제9조제18항제1호에 따른 투자신탁은 제외한다)의 경우에는 신탁재산에 귀속되는 소득에 대하여 그 신탁의 수탁자[내국법인 또는 「소득세법」에 따른 거주자(이하 “거주자”라 한다)인 경우에 한정한다]가 법인세를 납부할 의무가 있다. 이 경우 신탁재산별로 각각을 하나의 내국법인으로 본다.<신설 2020. 12. 22., 2023. 12. 31.>
...
제13조(과세표준) ① 내국법인의 각 사업연도의 소득에 대한 법인세의 과세표준은 각 사업연도의 소득의 범위에서 다음 각 호의 금액과 소득을 차례로 공제한 금액으로 한다. 다만, 제1호의 금액에 대한 공제는 각 사업연도 소득의 100분의 80[「조세특례제한법」 제6조제1항에 따른 중소기업(이하 “중소기업”이라 한다)과 회생계획을 이행 중인 기업 등 대통령령으로 정하는 법인의 경우는 100분의 100]을 한도로 한다. <개정 2020. 12. 22., 2022. 12. 31.>
...
제14조(각 사업연도의 소득) ① 내국법인의 각 사업연도의 소득은 그 사업연도에 속하는 익금(益金)의 총액에서 그 사업연도에 속하는 손금(損金)의 총액을 뺀 금액으로 한다. <개정 2018. 12. 24.>
...
제15조(익금의 범위) ① 익금은 자본 또는 출자의 납입 및 이 법에서 규정하는 것은 제외하고 해당 법인의 순자산(純資産)을 증가시키는 거래로 인하여 발생하는 이익 또는 수입[이하 “수익”(收益)이라 한다]의 금액으로 한다. <개정 2018. 12. 24.>
...
제16조(배당금 또는 분배금의 의제) ① 다음 각 호의 금액은 다른 법인의 주주 또는 출자자(이하 “주주등”이라 한다)인 내국법인의 각 사업연도의 소득금액을 계산할 때 그 다른 법인으로부터 이익을 배당받았거나 잉여금을 분배받은 금액으로 본다. <개정 2011. 12. 31., 2016. 12. 20., 2018. 12. 24.>
...
제27조의2(업무용승용차 관련비용의 손금불산입 등 특례) ① 「개별소비세법」 제1조제2항제3호에 해당하는 승용자동차(운수업, 자동차판매업 등에서 사업에 직접 사용하는 승용자동차로서 대통령령으로 정하는 것과 연구개발을 목적으로 사용하는 승용자동차로서 대통령령으로 정하는 것은 제외하며, 이하 이 조 및 제74조의2에서 “업무용승용차”라 한다)에 대한 감가상각비는 각 사업연도의 소득금액을 계산할 때 대통령령으로 정하는 바에 따라 손금에 산입하여야 한다. <개정 2018. 12. 24., 2019. 12. 31., 2021. 12. 21.>
...
제30조(책임준비금의 손금산입) ① 보험사업을 하는 내국법인(「보험업법」에 따른 보험회사는 제외한다)이 각 사업연도의 결산을 확정할 때 「수산업협동조합법」 등 보험사업 관련 법률에 따른 책임준비금(이하 이 조에서 “책임준비금”이라 한다)을 손비로 계상한 경우에는 대통령령으로 정하는 바에 따라 계산한 금액의 범위에서 그 계상한 책임준비금을 해당 사업연도의 소득금액을 계산할 때 손금에 산입한다. <개정 2018. 12. 24., 2022. 12. 31.>
...
제32조(해약환급금준비금의 손금산입) ① 「보험업법」에 따른 보험회사(이하 “보험회사”라 한다)가 해당 사업연도의 이익처분을 할 때 해약환급금준비금(보험회사가 보험계약의 해약 등에 대비하여 적립하는 금액으로서 대통령령으로 정하는 바에 따라 계산한 금액을 말한다. 이하 이 조에서 같다)을 적립하고, 그 적립한 금액의 범위에서 제60조제2항제2호에 따른 세무조정계산서에 계상을 한 경우에는 그 계상한 금액을 결산을 확정할 때 손비로 계상한 것으로 보아 해당 사업연도의 소득금액을 계산할 때 손금에 산입한다. <개정 2024. 12. 31.>
...
제38조(보험차익으로 취득한 자산가액의 손금산입) ① 내국법인이 유형자산(이하 이 조에서 “보험대상자산”이라 한다)의 멸실(滅失)이나 손괴(損壞)로 인하여 보험금을 지급받아 그 지급받은 날이 속하는 사업연도의 종료일까지 멸실한 보험대상자산과 같은 종류의 자산을 대체 취득하거나 손괴된 보험대상자산을 개량(그 취득한 자산의 개량을 포함한다)하는 경우에는 해당 자산의 가액 중 그 자산의 취득 또는 개량에 사용된 보험차익 상당액을 대통령령으로 정하는 바에 따라 그 사업연도의 소득금액을 계산할 때 손금에 산입할 수 있다. <개정 2018. 12. 24.>
...
제42조(자산ㆍ부채의 평가) ① 내국법인이 보유하는 자산과 부채의 장부가액을 증액 또는 감액(감가상각은 제외하며, 이하 이 조에서 “평가”라 한다)한 경우에는 그 평가일이 속하는 사업연도와 그 후의 각 사업연도의 소득금액을 계산할 때 그 자산과 부채의 장부가액은 평가 전의 가액으로 한다. 다만, 다음 각 호의 어느 하나에 해당하는 경우에는 그러하지 아니하다. <개정 2018. 12. 24.>
...
제52조(부당행위계산의 부인) ① 납세지 관할 세무서장 또는 관할지방국세청장은 내국법인의 행위 또는 소득금액의 계산이 특수관계인과의 거래로 인하여 그 법인의 소득에 대한 조세의 부담을 부당하게 감소시킨 것으로 인정되는 경우에는 그 법인의 행위 또는 소득금액의 계산(이하 “부당행위계산”이라 한다)과 관계없이 그 법인의 각 사업연도의 소득금액을 계산한다. <개정 2011. 12. 31., 2018. 12. 24.>
...
제53조(외국법인 등과의 거래에 대한 소득금액 계산의 특례) ① 납세지 관할 세무서장 또는 관할지방국세청장은 우리나라가 조세의 이중과세 방지를 위하여 체결한 조약(이하 “조세조약”이라 한다)의 상대국과 그 조세조약의 상호합의 규정에 따라 내국법인이 국외에 있는 지점ㆍ비거주자 또는 외국법인과 한 거래의 거래금액에 대하여 권한이 있는 당국 간에 합의를 하는 경우에는 그 합의에 따라 그 법인의 각 사업연도의 소득금액을 조정하여 계산할 수 있다.
...
제55조(세율) ① 내국법인의 각 사업연도의 소득에 대한 법인세는 제13조에 따른 과세표준에 다음 각 호의 구분에 따른 세율을 적용하여 계산한 금액(제55조의2에 따른 토지등 양도소득에 대한 법인세액 및 「조세특례제한법」 제100조의32에 따른 투자ㆍ상생협력 촉진을 위한 과세특례를 적용하여 계산한 법인세액이 있으면 이를 합한 금액으로 한다. 이하 “산출세액”이라 한다)을 그 세액으로 한다. <개정 2024. 12. 31.>
...
제57조(외국 납부 세액공제 등) ①내국법인의 각 사업연도의 소득에 대한 과세표준에 국외원천소득이 포함되어 있는 경우로서 그 국외원천소득에 대하여 대통령령으로 정하는 외국법인세액(이하 이 조 및 제73조에서 “외국법인세액”이라 한다)을 납부하였거나 납부할 것이 있는 경우에는 다음 계산식에 따른 금액(이하 이 조에서 “공제한도금액”이라 한다) 내에서 외국법인세액을 해당 사업연도의 산출세액에서 공제할 수 있다. <개정 2020. 12. 22., 2021. 12. 21., 2022. 12. 31.>
...
제58조(재해손실에 대한 세액공제) ① 내국법인이 각 사업연도 중 천재지변이나 그 밖의 재해(이하 “재해”라 한다)로 인하여 대통령령으로 정하는 자산총액(이하 이 조에서 “자산총액”이라 한다)의 100분의 20 이상을 상실하여 납세가 곤란하다고 인정되는 경우에는 다음 각 호의 법인세액에 그 상실된 자산의 가액이 상실 전의 자산총액에서 차지하는 비율을 곱하여 계산한 금액(상실된 자산의 가액을 한도로 한다)을 그 세액에서 공제한다. 이 경우 자산의 가액에는 토지의 가액을 포함하지 아니한다. <개정 2020. 12. 22.>
...
제59조(감면 및 세액공제액의 계산) ① 이 법 및 다른 법률을 적용할 때 법인세의 감면에 관한 규정과 세액공제에 관한 규정이 동시에 적용되는 경우에 그 적용순위는 별도의 규정이 있는 경우 외에는 다음 각 호의 순서에 따른다. 이 경우 제1호와 제2호의 금액을 합한 금액이 법인이 납부할 법인세액(제55조의2에 따른 토지등 양도소득에 대한 법인세액, 「조세특례제한법」 제100조의32에 따른 투자ㆍ상생협력 촉진을 위한 과세특례를 적용하여 계산한 법인세액 및 가산세는 제외한다)을 초과하는 경우에는 그 초과하는 금액은 없는 것으로 본다. <개정 2014. 12. 23., 2017. 12. 19., 2018. 12. 24.>
...
제62조(비영리내국법인의 이자소득에 대한 신고 특례) ① 비영리내국법인은 제4조제3항제2호에 따른 이자소득(「소득세법」 제16조제1항제11호의 비영업대금의 이익은 제외하고, 투자신탁의 이익을 포함하며, 이하 이 조에서 “이자소득”이라 한다)으로서 제73조 및 제73조의2에 따라 원천징수된 이자소득에 대하여는 제60조제1항에도 불구하고 과세표준 신고를 하지 아니할 수 있다. 이 경우 과세표준 신고를 하지 아니한 이자소득은 각 사업연도의 소득금액을 계산할 때 포함하지 아니한다. <개정 2018. 12. 24.>
② 제1항에 따른 비영리내국법인의 이자소득에 대한 법인세의 과세표준 신고와 징수에 필요한 사항은 대통령령으로 정한다.
[전문개정 2010. 12. 30.]
[제목개정 2018. 12. 24.]

제62조의2(비영리내국법인의 자산양도소득에 대한 신고 특례) ① 비영리내국법인(제4조제3항제1호에 따른 수익사업을 하는 비영리내국법인은 제외한다. 이하 이 조에서 같다)이 제4조제3항제4호부터 제6호까지의 수입으로서 다음 각 호의 어느 하나에 해당하는 자산의 양도로 인하여 발생하는 소득(이하 이 조에서 “자산양도소득”이라 한다)이 있는 경우에는 제60조제1항에도 불구하고 과세표준 신고를 하지 아니할 수 있다. 이 경우 과세표준 신고를 하지 아니한 자산양도소득은 각 사업연도의 소득금액을 계산할 때 포함하지 아니한다. <개정 2018. 12. 24., 2021. 12. 21., 2024. 12. 31.>
...
제63조(중간예납 의무) ① 사업연도의 기간이 6개월을 초과하는 내국법인은 각 사업연도(합병이나 분할에 의하지 아니하고 새로 설립된 법인의 최초 사업연도는 제외한다) 중 중간예납기간(中間豫納期間)에 대한 법인세액(이하 “중간예납세액”이라 한다)을 납부할 의무가 있다. 다만, 다음 각 호의 어느 하나에 해당하는 법인은 중간예납세액을 납부할 의무가 없다. <개정 2020. 12. 22., 2022. 12. 31.>
...
제63조의2(중간예납세액의 계산) ① 중간예납세액은 다음 각 호의 어느 하나의 방법을 선택하여 계산한다. 다만, 직전 사업연도 종료일 현재 「독점규제 및 공정거래에 관한 법률」 제31조제1항에 따른 공시대상기업집단에 속하는 내국법인(업종별 매출액 등을 고려하여 대통령령으로 정하는 법인은 제외한다)은 제2호의 방법에 따라 중간예납세액을 계산한다. <개정 2019. 12. 31., 2024. 12. 31.>
...
제73조의2(내국법인의 채권등의 보유기간 이자상당액에 대한 원천징수) ① 내국법인이 「소득세법」 제46조제1항에 따른 채권등 또는 투자신탁의 수익증권(이하 “원천징수대상채권등”이라 한다)을 타인에게 매도(중개ㆍ알선과 그 밖에 대통령령으로 정하는 경우를 포함하되, 환매조건부 채권매매 등 대통령령으로 정하는 경우는 제외한다. 이하 이 조, 제74조 및 제75조의18에서 같다)하는 경우 그 내국법인은 대통령령으로 정하는 바에 따라 계산한 해당 원천징수대상채권등의 보유기간에 따른 이자, 할인액 및 투자신탁이익(이하 이 조 및 제98조의3에서 “이자등”이라 한다)의 금액에 100분의 14의 세율을 적용하여 계산한 금액에 상당하는 법인세(1천원 이상인 경우만 해당한다)를 원천징수하여 그 징수일이 속하는 달의 다음 달 10일까지 납세지 관할 세무서등에 납부하여야 한다. 이 경우 해당 내국법인을 원천징수의무자로 보아 이 법을 적용한다. <개정 2020. 12. 22., 2021. 12. 21.>
...
제75조(성실신고확인서 제출 불성실 가산세) ① 제60조의2제1항에 따른 성실신고 확인대상인 내국법인이 각 사업연도의 종료일이 속하는 달의 말일부터 4개월 이내에 성실신고확인서를 납세지 관할 세무서장에게 제출하지 아니한 경우에는 다음 각 호의 금액 중 큰 금액을 가산세로 해당 사업연도의 법인세액에 더하여 납부하여야 한다. <개정 2021. 12. 21.>
...
제75조의7(지급명세서 등 제출 불성실 가산세) ① 제120조, 제120조의2 또는 「소득세법」 제164조, 제164조의2에 따른 지급명세서(이하 이 조에서 “지급명세서”라 한다)나 같은 법 제164조의3에 따른 간이지급명세서(이하 이 조에서 “간이지급명세서”라 한다)를 제출하여야 할 자가 다음 각 호의 어느 하나에 해당하는 경우에는 각 호에서 정하는 금액을 가산세로 해당 사업연도의 법인세액에 더하여 납부하여야 한다. <개정 2020. 12. 22., 2021. 3. 16., 2022. 12. 31.>
...
제75조의9(특정외국법인의 유보소득 계산 명세서 제출 불성실 가산세) ① 「국제조세조정에 관한 법률」 제34조제3호에 따른 특정외국법인의 유보소득 계산 명세서(이하 이 항에서 “명세서”라 한다)를 같은 조에 따라 제출하여야 하는 내국법인이 다음 각 호의 어느 하나에 해당하는 경우에는 해당 특정외국법인의 배당 가능한 유보소득금액의 1천분의 5를 가산세로 해당 사업연도의 법인세액에 더하여 납부하여야 한다. <개정 2020. 12. 22.>
...
제76조의8(연결납세방식의 적용 등) ① 다른 내국법인을 연결지배하는 내국법인[비영리법인 등 대통령령으로 정하는 법인은 제외하며, 이하 이 항에서 “연결가능모법인”이라 한다]과 그 다른 내국법인[청산 중인 법인 등 대통령령으로 정하는 법인은 제외한다. 이하 이 장에서 “연결가능자법인”이라 한다]은 대통령령으로 정하는 바에 따라 연결가능모법인의 납세지 관할지방국세청장의 승인을 받아 연결납세방식을 적용할 수 있다. 이 경우 연결가능자법인이 둘 이상일 때에는 해당 법인 모두가 연결납세방식을 적용하여야 한다. <개정 2013. 1. 1., 2022. 12. 31.>
...
제76조의9(연결납세방식의 취소) ① 연결모법인의 납세지 관할지방국세청장은 다음 각 호의 어느 하나에 해당하는 경우에는 대통령령으로 정하는 바에 따라 연결납세방식의 적용 승인을 취소할 수 있다. <개정 2013. 1. 1., 2015. 12. 15., 2022. 12. 31.>
...
제76조의16(연결법인의 세액감면 및 세액공제 등) ① 연결산출세액에서 공제하는 연결법인의 감면세액과 세액공제액은 각 연결법인별로 계산한 감면세액과 세액공제액의 합계액으로 한다. <개정 2018. 12. 24.>
...
제76조의18(연결중간예납) ① 연결사업연도가 6개월을 초과하는 연결모법인은 각 연결사업연도 개시일부터 6개월이 되는 날까지를 중간예납기간으로 하여 다음 각 호의 어느 하나에 해당하는 방법을 선택하여 계산한 금액(이하 이 장에서 “연결중간예납세액”이라 한다)을 중간예납기간이 지난 날부터 2개월 이내에 납세지 관할 세무서등에 납부하여야 한다. 다만, 연결모법인 또는 연결자법인이 직전 연결사업연도 종료일 현재 「독점규제 및 공정거래에 관한 법률」 제31조제1항에 따른 공시대상기업집단에 속하는 내국법인(업종별 매출액 등을 고려하여 대통령령으로 정하는 법인은 제외한다)에 해당하는 경우에는 제2호의 방법에 따라 계산한 연결중간예납세액을 납세지 관할 세무서등에 납부하여야 한다. <개정 2018. 12. 24., 2024. 12. 31.>
...
제92조(국내원천소득 금액의 계산) ① 제91조제1항에 해당하는 외국법인의 각 사업연도의 국내원천소득의 총합계액은 해당 사업연도에 속하는 익금의 총액에서 해당 사업연도에 속하는 손금의 총액을 뺀 금액으로 하며, 각 사업연도의 소득금액의 계산에 관하여는 대통령령으로 정하는 바에 따라 제14조부터 제18조까지, 제18조의2, 제19조, 제19조의2, 제20조부터 제31조까지, 제33조부터 제38조까지, 제40조부터 제42조까지, 제42조의2, 제43조, 제44조, 제44조의2, 제44조의3, 제45조, 제46조, 제46조의2부터 제46조의5까지, 제47조, 제47조의2, 제50조, 제51조, 제52조, 제53조, 제53조의2 및 제54조와 「조세특례제한법」 제138조를 준용한다. 다만, 제44조의3, 제45조, 제46조의3 및 제46조의4를 준용할 때 합병법인 및 분할신설법인등은 피합병법인 및 분할법인등의 결손금을 승계하지 아니하는 것으로 보아 각각의 규정을 준용한다. <개정 2011. 12. 31., 2013. 1. 1., 2018. 12. 24., 2019. 12. 31.>
...
2. 국내사업장이 없는 외국법인으로서 제93조제9호에 따른 국내원천 유가증권양도소득이 다음 각 목의 요건을 모두 갖춘 경우에는 제1호가목에도 불구하고 대통령령으로 정하는 정상가격(이하 이 호에서 “정상가격” 이라 한다)을 해당 수입금액으로 한다.
가. 국내사업장이 없는 외국법인과 대통령령으로 정하는 특수관계가 있는 외국법인(비거주자를 포함한다) 간의 거래일 것
나. 가목의 거래에 의한 거래가격이 정상가격보다 낮은 경우로서 대통령령으로 정하는 경우일 것
③ 제91조제2항에 따른 외국법인의 각 사업연도의 국내원천소득의 금액 중 제93조제7호에 따른 국내원천 부동산등양도소득 금액은 그 소득을 발생시키는 자산(이하 이 조에서 “토지등”이라 한다)의 양도가액에서 다음 각 호의 금액을 뺀 금액으로 한다.<개정 2018. 12. 24.>
1. 취득가액. 다만, 「상속세 및 증여세법」에 따라 상속세 과세가액 또는 증여세 과세가액에 산입되지 아니한 재산을 출연받은 외국법인이 대통령령으로 정하는 토지등을 양도하는 경우에는 그 토지등을 출연한 출연자의 취득가액을 그 외국법인의 취득가액으로 한다.
...
제94조의2(외국법인연락사무소 자료 제출) ① 외국법인이 국내에서 수익을 발생시키는 영업활동을 영위하지 아니하고 업무연락, 시장조사 등 대통령령으로 정하는 비영업적 기능만을 수행하는 사무소(제94조에 따른 국내사업장에 해당하지 아니하는 것을 말하며, 이하 이 조에서 “외국법인연락사무소”라 한다)를 국내에 두고 있는 경우에는 대통령령으로 정하는 현황 자료를 그 다음 연도 2월 10일까지 대통령령으로 정하는 바에 따라 외국법인연락사무소 소재지 관할 세무서장에게 제출하여야 한다. <개정 2022. 12. 31.>
...
⑭ 제93조제10호자목에 따른 국내원천소득은 주식등을 발행한 내국법인이 그 주식등을 보유하고 있는 국외특수관계인으로부터 대통령령으로 정하는 시기에 원천징수하여야 한다.<개정 2011. 12. 31.>
⑮ 제14항에 따른 원천징수의 구체적인 방법은 대통령령으로 정한다.
<16> 제1항에도 불구하고 가상자산사업자등을 통하여 발생하는 제93조제10호카목에 따른 외국법인의 국내원천 기타소득은 가상자산사업자등이 제1항제8호나목에 따른 금액을 원천징수하여 가상자산 또는 현금을 인출하는 달의 다음 달 10일(매년 1월 1일부터 12월 31일까지 인출하지 아니한 경우 그 다음연도 1월 10일)까지 대통령령으로 정하는 바에 따라 납세지 관할 세무서등에 납부하여야 한다.<신설 2020. 12. 22.>
<17> 제16항을 적용할 때 가상자산을 양도ㆍ대여ㆍ인출하는 자가 제1항제8호나목의 원천징수 대상에 해당하는지 여부에 대하여 가상자산사업자등이 확인하는 방법은 대통령령으로 정한다.<신설 2020. 12. 22.>
[전문개정 2010. 12. 30.]
[시행일: 2027. 1. 1.]  제98조

제98조의2(외국법인의 유가증권 양도소득 등에 대한 신고ㆍ납부 등의 특례) ① 국내사업장이 없는 외국법인은 동일한 내국법인의 주식 또는 출자증권을 동일한 사업연도(그 주식 또는 출자증권을 발행한 내국법인의 사업연도를 말한다. 이하 이 조에서 같다)에 2회 이상 양도함으로써 조세조약에서 정한 과세기준을 충족하게 된 경우에는 양도 당시 원천징수되지 아니한 소득(이하 이 조에서 “소득”이라 한다)에 대한 원천징수세액 상당액을 양도일이 속하는 사업연도의 종료일부터 3개월 이내에 대통령령으로 정하는 바에 따라 납세지 관할 세무서장에게 신고ㆍ납부하여야 한다.
...
제98조의4(외국법인에 대한 조세조약상 비과세 또는 면제 적용 신청) ① 제93조에 따른 국내원천소득(같은 조 제5호에 따른 국내원천 사업소득 및 같은 조 제6호에 따른 국내원천 인적용역소득은 제외한다)의 실질귀속자인 외국법인이 조세조약에 따라 비과세 또는 면제를 적용받으려는 경우에는 대통령령으로 정하는 바에 따라 비과세ㆍ면제신청서 및 국내원천소득의 실질귀속자임을 증명하는 서류(이하 이 조에서 “신청서등”이라 한다)를 국내원천소득을 지급하는 자(이하 이 조에서 “소득지급자”라 한다)에게 제출하고 해당 소득지급자는 그 신청서등을 납세지 관할 세무서장에게 제출하여야 한다. 이 경우 제93조의2제1항제1호에 해당하여 국외투자기구를 국내원천소득의 실질귀속자로 보는 경우에는 그 국외투자기구에 투자한 투자자의 국가별 현황 등이 포함된 국외투자기구 신고서를 함께 제출하여야 한다. <개정 2018. 12. 24., 2022. 12. 31.>
...
⑦ 제1항부터 제6항까지에서 규정된 사항 외에 신청서등 및 국외투자기구 신고서 등 관련 서류의 제출 방법ㆍ절차, 제출된 서류의 보관의무, 경정청구의 방법ㆍ절차 등 비과세 또는 면제의 적용에 필요한 사항은 대통령령으로 정한다.<개정 2022. 12. 31.>
[전문개정 2014. 1. 1.]
[시행일: 2026. 1. 1.] 제98조의4제1항 전단

제98조의5(특정지역 외국법인에 대한 원천징수절차 특례) ① 제98조, 제98조의2부터 제98조의4까지 및 제98조의6에 따른 원천징수의무자는 기획재정부장관이 고시하는 국가나 지역에 있는 외국법인의 국내원천소득 중 제93조제1호, 제2호, 같은 조 제7호나목, 같은 조 제8호 또는 제9호에 따른 소득에 대하여 각 사업연도의 소득에 대한 법인세로서 원천징수하는 경우에는 제98조의4 및 조세조약에 따른 비과세ㆍ면제 또는 제한세율 규정에도 불구하고 제98조제1항 각 호에서 규정하는 세율을 우선 적용하여 원천징수하여야 한다. 다만, 대통령령으로 정하는 바에 따라 조세조약에 따른 비과세ㆍ면제 또는 제한세율을 적용받을 수 있음을 국세청장이 미리 승인한 경우에는 그러하지 아니하다. <개정 2011. 12. 31.>
...
제116조(지출증명서류의 수취 및 보관) ① 법인은 각 사업연도에 그 사업과 관련된 모든 거래에 관한 증명서류를 작성하거나 받아서 제60조에 따른 신고기한이 지난 날부터 5년간 보관하여야 한다. 다만, 제13조제1항제1호에 따라 각 사업연도 개시일 전 5년이 되는 날 이전에 개시한 사업연도에서 발생한 결손금을 각 사업연도의 소득에서 공제하려는 법인은 해당 결손금이 발생한 사업연도의 증명서류를 공제되는 소득의 귀속사업연도의 제60조에 따른 신고기한부터 1년이 되는 날까지 보관하여야 한다. <개정 2018. 12. 24.>
...
제124조(명령사항위반에 대한 과태료) 납세지 관할 세무서장은 다음 각 호의 어느 하나에 해당하는 명령사항을 위반한 법인에 2천만원 이하의 과태료를 부과ㆍ징수한다.
...
[본조신설 2018. 12. 24.]
[시행일: 2026. 1. 1.]  제124조제3호



부칙 <제20775호,2025. 3. 14.>
...
export { CORPORATE_TAX_LAW, INCOME_TAX_LAW };
